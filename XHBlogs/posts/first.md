...
cover: "/cover-rcj-shop-launch.svg"
---

> **更新说明（2026-09）**：文中「¥9.9 / ¥39 / ¥69」三档定价已随 rcj-shop 改版下线。当前在售口径以 [shop.955827.xyz](https://shop.955827.xyz) 为准：题库定制 ¥99 起、建站服务 ¥299 起、管理后台 ¥49 起，另有 0 元购入口。本文保留为当时的部署记录。
